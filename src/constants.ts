...
export const STREAK_MILESTONES: { days: number; message: string; messageEn: string; bonus: number }[] = [
  { days: 3, message: '3 ימים ברצף! 🔥', messageEn: '3 days in a row! 🔥', bonus: 2 },
  { days: 5, message: '5 ימים ברצף! 🔥🔥', messageEn: '5 days in a row! 🔥🔥', bonus: 3 },
  { days: 7, message: 'שבוע מושלם! 🏆', messageEn: 'Perfect week! 🏆', bonus: 5 },
  { days: 14, message: 'שבועיים ברצף! 🏅', messageEn: '2 weeks in a row! 🏅', bonus: 10 },
  { days: 21, message: '3 שבועות! 💎', messageEn: '3 weeks! 💎', bonus: 15 },
  { days: 30, message: 'חודש מושלם! 👑', messageEn: 'Perfect month! 👑', bonus: 25 },
];
